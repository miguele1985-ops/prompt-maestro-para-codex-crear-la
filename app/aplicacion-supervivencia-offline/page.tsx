...
export const metadata = pageMetadata({ title: "Aplicación de supervivencia offline para Android", description: "Guías, mapas, calculadoras y preparación familiar en Modo Crisis Survival. Descarga, funciones y recursos de la app.", slug: "aplicacion-supervivencia-offline" });
    ...
    <>
        ...
        <div className="hero-visual" aria-label="Captura de Modo Crisis Survival en teléfono">
          ...
          <div className="app-brand-card">
            <img
              ...
              decoding="async"
            />
            <span>{visibleDownloadInfo.version}</span>
          </div>
      ...
      <section className="content-band app-explainer">
        <SectionHeader
          ...
          description="Consulta guías, prepara tus recursos y organiza un plan familiar antes de necesitarlo."
        />
      ...
      <section className="content-band">
        <SectionHeader
          ...
          title="Explora las funciones de la aplicación"
        />
