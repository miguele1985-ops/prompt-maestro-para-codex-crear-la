...
import { BatteryCharging, CheckCircle2, Database, HeartHandshake, Map, ShieldCheck } from "lucide-react";
import { AvailabilityBadge, SafetyWarning } from "@/components/Badges";
...
const appUseCases = [
  ...
  },
  {
    ...
    alt: "Pantalla de guías de supervivencia con categorías y artículos offline",
    points: ["309 artículos offline", "Agua", "Refugio", "Orientación", "Favoritos", "Categorías"],
  },
];
    ...
    <>
      <section className="hero">
        <div className="hero-copy">
          ...
          <div className="actions">
            <ApkDownloadButton />
            <Link className="hero-donate-button" href="/donaciones">
      ...
      <section className="content-band">
        <SectionHeader
          ...
          description="Las funciones se agrupan por intención: actuar rápido, preparar a la familia, consultar guías, usar recursos avanzados, trabajar sin cobertura y separar lo que sí necesita Internet."
        />
      ...
      <section className="content-band">
        <SectionHeader
          ...
          description="El objetivo comercial es que el visitante imagine la app instalada en su móvil y entienda cuándo la abriría."
        />
      ...
      <section className="content-band">
        <SectionHeader
          ...
          description="La app completa diferencia el APK de los recursos grandes. Eso permite explicar con honestidad qué viene dentro, qué se importa y qué debe preparar el usuario antes de quedarse sin cobertura."
        />
      ...
      <section className="split-section">
        <div>
          <SectionHeader eyebrow="Funcionamiento offline" title="Preparada para seguir siendo útil sin conexión" />
          <p>
            Aproximadamente el 99 % del contenido y las herramientas pueden utilizarse sin Internet cuando la aplicación y sus recursos han sido preparados previamente.
          </p>
          <div className="availability-row">
            <AvailabilityBadge value="offline" />
            <AvailabilityBadge value="hybrid" />
            <AvailabilityBadge value="online" />
          </div>
        </div>
        <div className="mini-card warning-card">
          <h3>Funciones que sí pueden necesitar conexión</h3>
          <ul>
            <li>Consulta de meteorología actualizada.</li>
            <li>Consulta de alertas actualizadas.</li>
            <li>Descarga inicial de determinados datos.</li>
            <li>Descarga o importación de modelos de IA.</li>
            <li>Descarga de mapas adicionales.</li>
      ...
      <section className="content-band">
        <SectionHeader
          eyebrow="Permisos transparentes"
          title="La web explica por qué la app puede pedir permisos sensibles"
          description="Ubicación, cámara, micrófono o archivos solo deben entenderse dentro de funciones concretas. La comunicación comercial evita prometer privacidad absoluta o automatismos no confirmados."
        />
        <div className="permission-grid">
          {permissionGroups.map((permission) => (
            <article className="permission-card" key={permission.title}>
      ...
      <section className="content-band">
        <SectionHeader
          eyebrow="Capturas y vídeo"
          title="Interfaz preparada para mostrar la aplicación real"
          description="Capturas reales de la aplicación organizadas por pantalla. Cuando envíes más imágenes, las iremos colocando en las secciones concretas que correspondan."
        />
        <ScreenshotGallery assets={screenshotAssets} />
        <div className="video-box">
          <div>
            <h3>Descubre cómo Modo Crisis Survival convierte tu móvil en una herramienta de preparación</h3>
            <p>Vídeo de presentación bajo demanda, sin reproducción automática con sonido, preparado para subtítulos, portada, transcripción y descarga.</p>
          </div>
          <button className="button secondary" type="button">Vídeo pendiente de añadir</button>
        </div>
      </section>

      {siteConfig.donations.enabled ? <section className="content-band donation-band" aria-labelledby="donation-title">
        <div className="donation-copy">
          <p className="eyebrow">Donaciones voluntarias</p>
          <h2 id="donation-title">Ayuda a que Modo Crisis Survival pueda seguir creciendo</h2>
          <p>
            Mantener una app de preparación offline exige desarrollo, pruebas, actualizaciones, revisión de contenidos, soporte, hosting y nuevas versiones. Si el proyecto no recibe apoyo, continuar mejorándolo a largo plazo se vuelve muy difícil.
          </p>
          <p>
            La app está pensada para poder usarse completa sin pagar. Donar no desbloquea funciones ni crea una suscripción obligatoria: es una forma de sostener el trabajo para que siga disponible, actualizado y útil.
          </p>
          <ul className="donation-list">
            <li>Corregir errores y probar nuevas APK.</li>
            <li>Actualizar contenidos, guías y documentación.</li>
            <li>Mantener web, dominio, soporte y recursos descargables.</li>
            <li>Añadir mejoras sin convertir la app en un producto cerrado.</li>
          </ul>
          <div className="actions">
            {isConfiguredDonationUrl(siteConfig.donations.primaryUrl) ? (
              <a className="button primary" href={siteConfig.donations.primaryUrl} target="_blank" rel="noreferrer">
                <HeartHandshake size={18} aria-hidden /> Hacer una donación
              </a>
            ) : (
              <Link className="button primary" href="/donaciones">
                <HeartHandshake size={18} aria-hidden /> Ver cómo apoyar
              </Link>
            )}
            <Link className="button secondary" href="/donaciones">Por qué donar</Link>
          </div>
        </div>
        <div className="donation-card">
          ...
          <div className="donation-platforms" aria-label="Opciones de donación configurables">
      ...
      <section className="split-section">
        <div>
          <SectionHeader eyebrow="Conversión" title="Una aplicación pensada para funcionar cuando otras dejan de hacerlo" />
          <p>Modo Crisis Survival reúne en una sola aplicación herramientas de preparación personal, familiar y urbana.</p>
          <ul className="check-list">
            <li>Anticiparse a los riesgos.</li>
            <li>Organizar recursos.</li>
            <li>Mantener la calma.</li>
            <li>Encontrar información rápidamente.</li>
            <li>Utilizar mapas y herramientas sin Internet.</li>
          </ul>
        </div>
        <div className="cta-panel">
          <BatteryCharging aria-hidden />
          <h2>Prepárate hoy para responder mejor mañana</h2>
          <p>Descarga Modo Crisis Survival, configura tu plan familiar, guarda tus mapas offline y lleva contigo una completa biblioteca de supervivencia y actuación ante emergencias.</p>
          <blockquote>«{siteConfig.slogan}»</blockquote>
          <ApkDownloadButton label="Descargar Modo Crisis Survival" />
          <ShareButtons title={siteConfig.appName} />
        </div>
      </section>
