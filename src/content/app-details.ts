...
export const resourceDetails = [
  ...
  },
  {
    ...
    text: "La app contempla importar un modelo GGUF, con Qwen 2.5 0.5B Instruct Q4_K_M como modelo recomendado en la configuración técnica.",
    tags: ["GGUF", "Qwen", "local"],
  },
  {
