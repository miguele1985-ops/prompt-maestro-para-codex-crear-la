...
const baseSiteConfig = {
  ...
  seo: {
    title: "Modo Crisis Survival: aplicaciÃ³n de supervivencia offline y emergencias",
    description:
    "Aplicaci\u00f3n de supervivencia offline, preparaci\u00f3n familiar, mapas MBTiles, gu\u00edas, bot\u00f3n SOS, calculadoras, inventarios, IA local opcional y herramientas para emergencias.",
    keywords: [
      "aplicaciÃ³n de supervivencia offline",
      "app de supervivencia",
      "aplicaciÃ³n para emergencias",
      "aplicaciÃ³n sin Internet",
      "guÃ­as de supervivencia",
      "mapas offline de EspaÃ±a",
      "app para apagones",
      "preparaciÃ³n familiar ante emergencias",
      "mapas MBTiles",
...
export const navigation = [
  { label: "Inicio", href: "/" },
  { label: "GuÃ­as", href: "/guias-supervivencia" },
